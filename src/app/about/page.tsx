    ...
    <div className="min-h-screen flex flex-col bg-cornsilk">
      ...
      <main className="flex-grow container mx-auto py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-12 bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h3 className="font-bold text-black mb-2">Upload</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="font-bold text-black mb-2">Browse</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="font-bold text-black mb-2">Learn</h3>
          ...
          <section className="mb-12 bg-white p-6 rounded-lg shadow-md">
            <h2 className="text-2xl font-bold text-black mb-4">Guidelines for Uploading</h2>
          ...
          <section className="mb-12 bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="mt-8">
              <Link href="/contact" className="bg-tigers-eye hover:bg-opacity-90 text-black px-6 py-3 rounded-md inline-block">
                Send us a message
              </Link>
            </div>
          </section>
